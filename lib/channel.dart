...
class RestChannel extends ApplicationChannel
  ...
  Future prepare() async {
    ...
    final config = RestConfiguration(options.configurationFilePath);
  ...
  Controller get entryPoint {
    ...
    router
        .route("/")
        .linkFunction((request)=> Response.ok('test'));
...
class RestConfiguration extends Configuration {
  RestConfiguration(String fileName) : super.fromFile(File(fileName));
