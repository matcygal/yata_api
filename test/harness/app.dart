...
export 'package:rest/rest.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for rest.
///
...
///         }
///
class Harness extends TestHarness<RestChannel> with TestHarnessAuthMixin<RestChannel>, TestHarnessORMMixin {
  @override
